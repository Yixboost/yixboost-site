...
$jsonFilePath = '/login/logins.json';
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WVXWW528"
...
function formatViews($views) {
    if ($views >= 1000) {
        // Bereken het aantal K met 1 decimaal
        $formattedViews = number_format($views / 1000, 1) . 'K';
    } else {
        // Als minder dan 1000, geef gewoon het getal terug
...
if (!empty($categories)) {
    foreach ($categories as $category) {
        ...
        // URL naar de volledige categorie pagina
        ...
        foreach ($games as $gameId => $game) {
            if ($game['cat'] == $category) {
                ...
                // Gebruik de formatViews functie om de views correct weer te geven
